...
Every program card, grouped by stage. Each has a summary (shown on the card) plus offers and a takeaway (shown when expanded). Keep id, stage, status, accent-related fields; edit the wording.
-->
