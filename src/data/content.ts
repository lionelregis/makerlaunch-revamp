...
export interface Mentor {
  name: string;
  role: string;
  /** Broad field, used for filtering on the directory page. */
  field: string;
  bio: string;
  expertise: string[];
  quote: string;
...
export const mentors: Mentor[] = [
  ...
  },
  {
    ...
    expertise: ['Software products', 'Go-to-market', 'Early-stage metrics'],
  ...
  },
  {
    ...
    expertise: ['Energy & utilities', 'B2B sales', 'Scaling teams'],
    quote: 'I was the team nobody bet on. Now I get to be the person who bets on the next one.',
  },
  {
    name: 'Raj Patel, P.Eng.',
    role: 'Director of Engineering, aerospace · PEO mentor',
    field: 'Hardware',
    bio: 'A mechanical engineer with two decades in aerospace manufacturing. He helps hardware teams think about tolerances, certification, and building things that have to work the first time.',
    expertise: ['Aerospace & manufacturing', 'Systems engineering', 'Certification'],
    quote: 'Students bring the boldness; I bring the scar tissue. Together that’s a company that actually ships.',
  },
  {
    name: 'Élise Gagnon',
    role: 'UX & product design lead · design mentor',
    field: 'Design',
    bio: 'A software engineering grad turned product designer who has shaped apps used by millions. She runs the Design-phase workshops and pushes teams to talk to users early and often.',
    expertise: ['Product design', 'User research', 'Prototyping'],
    quote: 'The best engineers I mentor learn to fall in love with the problem, not their first solution.',
  },
  {
    name: 'Tunde Adeyemi',
    ...
    expertise: ['Fintech', 'Fundraising', 'Founder resilience'],
    quote: 'Nobody told me how lonely the early days would be. I mentor so these founders know someone’s in their corner.',
  },
  {
    name: 'Dr. Hannah Weiss',
    role: 'Professor of biomedical engineering · research-founder advisor',
    field: 'Health & Medtech',
    bio: 'A faculty researcher who has co-founded two medtech spinouts. She bridges the lab and the market, helping graduate students decide what’s actually worth commercializing.',
    expertise: ['Medtech', 'Research-to-market', 'Grants & IP'],
    quote: 'Great research deserves a path out of the lab. I help students find it without losing the science along the way.',
  },
  {
    name: 'Kevin Nguyen',
    role: 'Hardware engineer · makerspace mentor · MakerLaunch ’22',
    field: 'Hardware',
    bio: 'A recent electrical engineering grad building consumer hardware. He practically lives in the makerspace and loves helping first-timers get from a breadboard to a real prototype.',
    expertise: ['Embedded systems', 'Rapid prototyping', 'Makerspace'],
    quote: 'Two years ago I was the one here asking for help. Paying it forward is the least I can do.',
  },
];

export const mentorsPage = {
  eyebrow: 'Mentors & advisors',
  title: 'The people who build the next generation.',
  subtitle:
    'Alumni founders, industry practitioners, and Professional Engineers of Ontario who give their time to our founders — as mentors, Demo Day reviewers, workshop leaders, and case contributors.',
  filterLabel: 'Filter by field',
  filterAll: 'All',
  countLabel: 'mentors & advisors',
  emptyLabel: 'No mentors in this field yet.',
};
