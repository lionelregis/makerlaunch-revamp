...
import { programs, stages, umbrella } from '../data/content';
...
/* ------------------------------------------------------------------ */
/* StageDetail — one stage/track: description, criteria, and programs  */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* PipelineExplorer — three stages, with MakerLaunch holding two tracks */
/* ------------------------------------------------------------------ */
export function PipelineExplorer({ initialStage }: { initialStage?: StageId }) {
  ...
  return (
    <div>
      ...
      <div className="mt-6">
        {active === 'explore' && <StageDetail stage={byId.explore} />}
